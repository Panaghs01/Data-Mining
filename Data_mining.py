...
rule6a = ctrl.Rule(actual_productivity_fuzzy['good'] & (productivity_ratio_fuzzy['average'] | productivity_ratio_fuzzy['good']) , expectation_concern['medium'])
rule6b = ctrl.Rule(actual_productivity_fuzzy['good'] & (productivity_ratio_fuzzy['average'] | productivity_ratio_fuzzy['good']), production_concern['low'])
